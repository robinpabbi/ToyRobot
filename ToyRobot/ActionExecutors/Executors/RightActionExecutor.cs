...
{
    [ActionExecutor(UserAction.RIGHT)]
    internal class RightActionExecutor : IActionExecutor
    {
        ...
        public void Execute(ITableTop tableTop, ITablePositionValidator positionValidator, string actionParam = null)
        {
            ...
            var targetFacing = (Direction)(((int)currentFacing + 1) % 4);

            Console.WriteLine($"Moved Right from {currentFacing} to {targetFacing}.");
